...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/segundo_juego.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/segundo_juego ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/CApp_OnEvent.o: CApp_OnEvent.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CApp_OnEvent.o CApp_OnEvent.cpp

${OBJECTDIR}/CCartel.o: CCartel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CCartel.o CCartel.cpp

${OBJECTDIR}/CEnemy.o: CEnemy.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CEnemy.o CEnemy.cpp
...
${OBJECTDIR}/CGate.o: CGate.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CGate.o CGate.cpp

${OBJECTDIR}/CImage.o: CImage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CImage.o CImage.cpp

${OBJECTDIR}/CModel2D.o: CModel2D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CModel2D.o CModel2D.cpp

${OBJECTDIR}/CMovil.o: CMovil.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CMovil.o CMovil.cpp

${OBJECTDIR}/CObj.o: CObj.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CObj.o CObj.cpp
...
${OBJECTDIR}/CScenery.o: CScenery.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CScenery.o CScenery.cpp
